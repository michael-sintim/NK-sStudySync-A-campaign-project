...
/**
 * THEME CONFIGURATION
 * Maintaining the amber/black/red palette from the original
 */
const THEME = {
  amber: "#F5A300",
  amberLight: "#FFB800",
...
.nav-cta:hover { 
  ...
  .drawer-close {
    ...
    font-size: 1.2rem; cursor: pointer; font-family: 'Oswald', sans-serif;
    font-weight: 700;
  }
  ...
  .hero-sub {
    font-size: 1.15rem; color: var(--black-soft); line-height: 1.8;
    max-width: 680px; margin: 0 auto 3rem; font-weight: 600;
  }
  ...
  /* AFTER - solid red color, no gradient */
.section-red { 
  width: 100%; 
  background: #D32F2F;  /* Solid red, no gradient */
  border-top: 4px solid var(--black); 
  border-bottom: 4px solid var(--black); 
}

/* Also adjust the inner container for this section to have less margin */
/* Find the .section-inner class or add a specific override for impact section */

/* Add this new class or modify the existing one */
.section-red .section-inner {
  max-width: 1400px;  /* Increased from 1200px */
  width: 100%;
  margin: 0 auto;
  padding: 100px 2%;  /* Reduced side padding from 5% to 2% */
}

/* Make the logo strip wider */
.section-red .logo-strip {
  overflow: hidden;
  border-top: 3px solid rgba(255,255,255,0.3);
  padding-top: 2rem;
  width: 100%;
  margin-left: -2%;  /* Pull left to edge */
  margin-right: -2%; /* Pull right to edge */
  width: 104%;       /* Compensate for negative margins */
}

/* Make the pills slightly larger */
.section-red .logo-pill {
  ...
  white-space: nowrap;
  box-shadow: 4px 4px 0 rgba(0,0,0,0.25);  /* Slightly larger shadow */
}
  .section-black { 
    width: 100%; 
  ...
  .join-section {
    width: 100%;
    #F5A300; border-top: 5px solid var(--black); 
    border-bottom: 5px solid var(--black);
  }
  ...
  .mission-card h3, .feature-card h3 { 
    font-size: 1.5rem; 
    color: var(--red); 
    margin-bottom: 0.75rem; 
  }
  .mission-card p, .feature-card p { 
  ...
  .big-quote {
    font-family: 'Oswald', sans-serif; font-size: 5rem; color: var(--red);
    opacity: 0.25; position: absolute; top: 0.5rem; right: 1.5rem; line-height: 1;
  }
  .stars { 
    color: var(--red); 
    margin-bottom: 1.5rem; 
  ...
  .signup-form input {
    ...
    background: rgba(0,0,0,0.2); border: 3px solid var(--black); border-right: none;
  ...
  .signup-form button:hover { background: #333333; }
  .social-row { 
    display: flex; 
    align-items: center; 
    justify-content: center; 
  ...
  .social-btn {
    background: var(--black); color: var(--amber);
    border: 3px solid var(--black); padding: 0.6rem 1.3rem;
...
.ss-soc-btn:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0,0,0,0.25); }
    ...
    <>
      ...
      <nav className={`nav${scrolled ? " scrolled" : ""}`}>
        <div className="nav-logo" onClick={() => scrollTo("hero")}>
          ...
          <span>
            <span className="logo-nk">Nk's</span> StudySync
          </span>
        </div>
        <ul className="nav-links">
          {[
            ["mission", "Mission"],
            ["problem", "Why StudySync"],
            ["features", "Features"],
            ["impact", "Impact"],
            ["voices", "Students"],
            ["join", "Join"],
      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-content">
          <div className="hero-badge">
            🗳️ THE CAMPAIGN FOR ACADEMIC EXCELLENCE
          </div>
          ...
          <div className="hero-btns">
            <button className="btn-primary" onClick={() => scrollTo("join")}>
              Join the Campaign
            </button>
            <button
        ...
        <div className="section-inner">
          <RevealSection>
            <div style={{ textAlign: "center", marginBottom: "1rem" }}>
              <span className="section-tag bg-white">OUR MISSION</span>
            </div>
            <blockquote className="pull-quote">
              "Every student deserves tools that match their{" "}
              <span className="red">ambition.</span>"
            </blockquote>
          </RevealSection>
          <div className="mission-grid">
            {[
              ...
              },
              {
                ...
                desc: "AI that understands how you think, not just what you're studying. Personalised to your pace, your subjects, your goals.",
                delay: "d3",
              },
            ].map((c) => (
      ...
      <section className="section-black" id="problem">
        <div className="section-inner">
          <RevealSection>
            ...
            <h2
              className="section-title-amber"
              style={{ marginBottom: "3rem" }}
            >
              The Academic Crisis{" "}
              <span style={{ color: "#fff" }}>We're Solving</span>
            </h2>
          </RevealSection>
          <div className="problem-grid">
            <RevealSection>
              <div className="stat-cluster">
                <StatCard
                  target={73}
                  suffix="%"
                  label="of students report disorganised study habits"
                />
                <StatCard
                  target={60}
                  suffix="%"
                  label="miss deadlines due to poor scheduling"
                />
                <StatCard
                  target={80}
                  suffix="%"
                  label="use 5+ disconnected apps to study"
                />
                <StatCard
                  target={12}
                  suffix="%"
                  label="feel their study tools are actually effective"
                />
              </div>
            </RevealSection>
            <RevealSection className="d2">
              <div className="problem-text">
                ...
                <p>
                  The modern student is not lazy — they're overwhelmed. They
                  juggle calendars, group chats, document platforms, flashcard
                  apps, and note-taking tools that don't talk to each other. The
                  result? Fragmented focus, missed deadlines, and grades that
                  don't reflect real potential.
                </p>
                <p>
                  This isn't a student problem. It's a systemic failure of the
                  tools available to them.{" "}
                  <strong style={{ color: "var(--amber)" }}>
                    Nk's StudySync exists to fix that — once and for all.
                  </strong>
                </p>
              </div>
            </RevealSection>
        ...
        <div className="section-inner">
          <RevealSection>
            ...
            <p className="section-sub-black">
              Everything you need to study smarter — built into a single,
              seamless experience.
            </p>
          </RevealSection>
            ...
            {[
              {
                ...
                desc: "AI builds your weekly study plan around your deadlines, energy patterns, and subject weighting. Never scramble before an exam again.",
                delay: "d1",
              },
              {
                icon: "👥",
                title: "Real-Time Study Rooms",
                desc: "Live collaboration with screen sharing, shared whiteboards, and Pomodoro timers — productive sessions, every single time.",
                delay: "d2",
              },
              {
                icon: "📊",
                title: "Progress Dashboard",
                desc: "Visual performance tracking across all subjects. See your gaps, celebrate your wins, and stay on track to your goals.",
                delay: "d3",
              },
              {
                icon: "🤖",
                title: "AI Tutor Integration",
                desc: "Ask questions, get instant contextual answers. The AI tutor understands your curriculum and adapts to your learning style.",
                delay: "d1",
              },
              {
                icon: "📁",
                title: "Resource Hub",
                desc: "Centralised notes, past papers, and study materials — organised by subject, topic, and year level. Always one click away.",
                delay: "d2",
              },
              {
                icon: "🔔",
                title: "Smart Reminders",
                desc: "Adaptive nudges that know when you need a push vs. when you need a break. Study sustainably, not frantically.",
                delay: "d3",
              },
            ].map((f) => (
        ...
        <div className="section-inner">
          <RevealSection>
            ...
            <h2 className="section-title-white">
              The Numbers{" "}
              <span style={{ color: "var(--amber)" }}>Don't Lie</span>
            </h2>
            <p className="section-sub-white">
              Real results from real students. No spin, no cherry-picking.
            </p>
          </RevealSection>
          <div className="impact-grid">
            <ImpactStat
              ...
              suffix="+"
              format="short"
              label="Students Already Using StudySync"
            />
            <ImpactStat
              target={89}
              suffix="%"
              label="Report Better Grades Within 4 Weeks"
            />
            <ImpactStat
              target={2300000}
              suffix=""
            ...
            <ImpactStat
              target={97}
              suffix="%"
              label="Would Recommend to a Classmate"
            />
          </div>
          <RevealSection>
      ...
      <section className="section-amber" id="voices">
        <div className="section-inner">
          <RevealSection>
            ...
            <p className="section-sub-black">
              Don't take our word for it — hear from the students already in the
              movement.
            </p>
          </RevealSection>
            ...
            {[
              {
                initials: "AT",
                name: "Amara T.",
                school: "Year 12 · Sydney Grammar",
                quote:
                  "StudySync turned my chaotic exam prep into a structured system. I went from failing to distinctions in one semester. I genuinely didn't believe a tool could make this much difference.",
                delay: "d1",
              },
              {
                initials: "JK",
                name: "Jordan K.",
                school: "First Year · University of Melbourne",
                quote:
                  "The study rooms are incredible. My group went from scattered WhatsApp chats to focused, productive sessions. Our group assignment marks went up across the board.",
                delay: "d2",
              },
              {
                initials: "PM",
                name: "Priya M.",
                school: "HSC Student · North Sydney Girls",
                quote:
                  "The AI tutor actually explains things in a way that makes sense for how I think. It's like having a personal tutor available at 2am before an exam.",
                delay: "d3",
              },
            ].map((t) => (
      ...
      <section className="section-black" id="manifesto">
        <div className="section-inner">
          <RevealSection>
            ...
            >
              Our Five-Point{" "}
              <span style={{ color: "#fff" }}>Academic Manifesto</span>
            </h2>
          </RevealSection>
            ...
            {[
              {
                ...
                sub: "Free Tier For All",
                desc: "Every student deserves access to the core tools they need to succeed. No paywalls on essential features. No student left behind because they can't afford a premium plan.",
                delay: "d1",
              },
              {
                n: "02",
                heading: "Student Privacy First —",
                sub: "Zero Data Selling",
                desc: "We will never sell your data to advertisers. Full GDPR and Privacy Act compliance. Your academic life is yours — we're just here to help you manage it.",
                delay: "d2",
              },
              {
                n: "03",
                heading: "Teacher Integration —",
                sub: "Built With Educators",
                desc: "StudySync is co-designed with teachers, tutors, and academic staff. It fits into existing school infrastructure, not against it.",
                delay: "d3",
              },
              {
                n: "04",
                ...
                sub: "Monthly Updates",
                desc: "We ship new features every month, driven entirely by student feedback. The product roadmap is voted on by the community. You decide what we build next.",
                delay: "d2",
              },
              {
                n: "05",
                heading: "Community Over Competition —",
                sub: "Collaborative Not Cutthroat",
                desc: "Academic success shouldn't be a zero-sum game. StudySync is designed to lift every student up — not to pit you against your classmates.",
                delay: "d3",
              },
            ].map((m) => (
              <RevealSection key={m.n} className={m.delay}>
                <div className="manifesto-item">
                  ...
                  <div className="manifesto-content">
                    <h3>
                      <span style={{ color: "var(--amber)" }}>{m.heading}</span>{" "}
                      {m.sub}
                    </h3>
                    <p>{m.desc}</p>
                  </div>
        ...
        <div className="section-inner">
          <RevealSection>
            <div style={{ textAlign: "center", marginBottom: "0.5rem" }}>
              <span
                className="section-tag"
                style={{ background: "var(--black)", color: "var(--amber)" }}
              >
                JOIN THE MOVEMENT
              </span>
            </div>
            ...
            >
              Be Part of the{" "}
              <span style={{ color: "var(--red)" }}>StudySync Movement</span>
            </h2>
            <p className="section-sub-black">
              Sign up to get early access, vote for Nk's StudySync as your
              institution's official platform, and join 50,000 students changing
              how we learn.
            </p>
          </RevealSection>
          <RevealSection className="d1">
            ...
            <div className="ss-socials">
              ...
              {/* X / Twitter */}
              <button className="ss-soc-btn" style={{ background: "#000000" }}>
              ...
              {/* WhatsApp */}
              <button className="ss-soc-btn" style={{ background: "#25D366" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
              ...
              {/* TikTok */}
              <button className="ss-soc-btn" style={{ background: "#010101" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
        ...
        <div className="footer-inner">
          <div className="footer-top">
            <div className="footer-brand">
              ...
              <div className="footer-tagline">
                Built by students, for students. Shaping Tomorrow's Engineers
                Today.
              </div>
            </div>
            <div className="footer-links">
              {["About", "Features", "Blog", "Privacy Policy", "Contact"].map(
                (l) => (
                  <a key={l} href="#">
                    {l}
                  </a>
          ...
          <div className="footer-bottom">
            <span className="footer-copy">
              © 2025 Nk's StudySync. All rights reserved.
            </span>

            {/* AFTER - with actual icons */}
